/*
* The file is modified from TinyGL-0.4
*/
#ifndef _YGL_H_
#define _YGL_H_
...
enum {
	...
	GL_LIGHT_MODEL_COLOR_CONTROL = 0x1B54,//extension
...
// 	GL_EDGE_FLAG_ARRAY_POINTER_EXT	= 0x8093,
	...
	/* 1.2 extension */
	GL_SINGLE_COLOR = 0x0001,
	GL_SEPARATE_SPECULAR_COLOR = 0x0002
};
...
#define PROTO_GL3(name)				\
	...
	void gl ## name ## 3i(int,int,int);	\
	void gl ## name ## 3iv(int *);
...
#define PROTO_GL4(name)				\
	...
	void gl ## name ## 4i(int,int,int,int);	\
	void gl ## name ## 4iv(int *);
